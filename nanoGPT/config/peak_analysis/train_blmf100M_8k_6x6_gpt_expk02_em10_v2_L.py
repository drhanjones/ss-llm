...
max_iters = 352000 #44000 44000*8 (Batch size 32 instead of 256)
...
learning_rate = 5e-4 #2e-5 #1e-5 #Default GPT2 acc to Andrej Repo is 6e-4. LR used in 6x6_10M is 5e-4
lr_decay_iters = 352000 # make equal to max_iters usually
