...
curriculum_pacing_fn_name = "linear"
curriculum_start_percent = 0.2 #When does the curriculum start increasing the difficulty, in  terms of percentage of total steps
curriculum_end_percent = 0.8 #When does the curriculum reach maximum difficulty, in terms of percentage of total steps
curriculum_start_difficulty = 0.03 #Starting difficulty of the dataset as a percentile of the dataset's difficulty
