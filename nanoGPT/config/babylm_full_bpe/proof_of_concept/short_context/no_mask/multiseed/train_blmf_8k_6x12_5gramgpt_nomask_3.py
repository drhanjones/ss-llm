...
out_dir = f'output_dump/out-{dataset}-{lay_x_head}-{mask_part}-{unique_id}-5gramgpt'
wandb_run_name = f'{dataset}_{lay_x_head}_{mask_part}_gpt2_{sysname}_run_{unique_id}_5gramgpt'
