...
if init_from == "resume":
    out_dir = "output_dump/out-babylm_full_bpe_8k-6x6-nomask-6092910-2gramadj"
    wandb_run_id = 'eiibykm6'
    wandb_run_name = 'babylm_full_bpe_8k_6x6_nomask_gpt2_server_run_6092910_2gramadj'
    ...
    out_dir = f'output_dump/out-{dataset}-{lay_x_head}-{mask_part}-{unique_id}-2gramadj'
    wandb_run_name = f'{dataset}_{lay_x_head}_{mask_part}_gpt2_{sysname}_run_{unique_id}_2gramadj'
