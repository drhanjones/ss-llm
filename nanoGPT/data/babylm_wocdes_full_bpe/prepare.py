...
dev_ds = 'babylm_dev'
#dataset_name = "full"
dataset_name = ["bnc_spoken", "cbt", "children_stories", "gutenberg", "open_subtitles", "qed", "simple_wikipedia", "switchboard", "wikipedia"]
textfiles = [f"{dataset_folder_path}/{train_ds}/bnc_spoken.train",
...
if dataset_name == "full":
    ...
    train_file_path = [os.path.join(dataset_folder_path, train_ds, x + '.train') for x in dataset_name]
    dev_file_path = [os.path.join(dataset_folder_path, dev_ds, x + '.dev') for x in dataset_name]
...
#When using babylm minus cds

# Tokenizer vocab size: 16000
# train has 13,150,204 tokens
# val has 12,626,987 tokens
