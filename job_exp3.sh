...
torchrun --standalone --nproc_per_node=4 train.py config/babylm_full_bpe/8k_multiseed/train_blmf_8k_6x6_gpt_nomask_1.py &

torchrun --standalone --nproc_per_node=4 train.py config/babylm_full_bpe/8k_multiseed/train_blmf_8k_6x6_gpt_nomask_2.py &

torchrun --standalone --nproc_per_node=4 train.py config/babylm_full_bpe/8k_multiseed/train_blmf_8k_6x6_gpt_nomask_3.py &
